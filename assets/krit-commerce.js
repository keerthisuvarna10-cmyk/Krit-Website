        ...
        '<div class="krit-auth-account-card">',
          '<div class="krit-account-shell">',
            '<aside class="krit-account-sidebar">',
              '<div class="krit-account-profile-head" style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px">',
                '<div style="display:flex;gap:14px;align-items:flex-start;flex:1;min-width:0">',
                  ...
                  '</div>',
                '</div>',
                '<button type="button" onclick="kritLogout()" style="flex:0 0 auto;padding:8px 14px;border-radius:10px;border:1px solid rgba(249,213,72,.45);background:rgba(249,213,72,.08);color:#F9D548;font-size:.72rem;font-weight:800;letter-spacing:.12em;text-transform:uppercase;cursor:pointer;white-space:nowrap" aria-label="Log out of your KRIT account">Logout</button>',
              '</div>',
